...
static HANIMATIONBUFFER (WINAPI* theme_BeginBufferedAnimation)(HWND,HDC,const RECT*,BP_BUFFERFORMAT,BP_PAINTPARAMS*,BP_ANIMATIONPARAMS*,HDC*,HDC*) = NULL;
static HPAINTBUFFER (WINAPI* theme_BeginBufferedPaint)(HDC,const RECT*,BP_BUFFERFORMAT,BP_PAINTPARAMS*,HDC*) = NULL;
static BOOL     (WINAPI* theme_BeginPanningFeedback)(HWND) = NULL;
static HRESULT  (WINAPI* theme_BufferedPaintClear)(HPAINTBUFFER,const RECT*) = NULL;
static HRESULT  (WINAPI* theme_BufferedPaintInit)(void) = NULL;
static BOOL     (WINAPI* theme_BufferedPaintRenderAnimation)(HWND,HDC) = NULL;
static HRESULT  (WINAPI* theme_BufferedPaintSetAlpha)(HPAINTBUFFER,const RECT*,BYTE) = NULL;
static HRESULT  (WINAPI* theme_BufferedPaintStopAllAnimations)(HWND) = NULL;
static HRESULT  (WINAPI* theme_BufferedPaintUnInit)(void) = NULL;
static HRESULT  (WINAPI* theme_CloseThemeData)(HTHEME) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeBackground)(HTHEME,HDC,int,int,const RECT*,const RECT*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeBackgroundEx)(HTHEME,HDC,int,int,const RECT*,const DTBGOPTS*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeEdge)(HTHEME,HDC,int,int,const RECT*,UINT,UINT,RECT*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeIcon)(HTHEME,HDC,int,int,const RECT*,HIMAGELIST,int) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeParentBackground)(HWND,HDC,RECT*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeParentBackgroundEx)(HWND,HDC,DWORD,RECT*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeText)(HTHEME,HDC,int,int,const WCHAR*,int,DWORD,DWORD,const RECT*) = NULL;
static HRESULT  (WINAPI* theme_DrawThemeTextEx)(HTHEME,HDC,int,int,const WCHAR*,int,DWORD,RECT*,const DTTOPTS*) = NULL;
...
static HRESULT  (WINAPI* theme_GetBufferedPaintTargetRect)(HPAINTBUFFER,RECT*) = NULL;
static HRESULT  (WINAPI* theme_GetCurrentThemeName)(WCHAR*,int,WCHAR*,int,WCHAR*,int) = NULL;
static DWORD    (WINAPI* theme_GetThemeAppProperties)(void) = NULL;
static HRESULT  (WINAPI* theme_GetThemeBackgroundContentRect)(HTHEME,HDC,int,int,const RECT*,RECT*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeBackgroundExtent)(HTHEME,HDC,int,int,const RECT*,RECT*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeBackgroundRegion)(HTHEME,HDC,int,int,const RECT*,HRGN*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeBitmap)(HTHEME,int,int,int,ULONG,HBITMAP*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeBool)(HTHEME,int,int,int,BOOL*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeColor)(HTHEME,int,int,int,COLORREF*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeDocumentationProperty)(const WCHAR*,const WCHAR*,WCHAR*,int) = NULL;
static HRESULT  (WINAPI* theme_GetThemeEnumValue)(HTHEME,int,int,int,int*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeFilename)(HTHEME,int,int,int,WCHAR*,int) = NULL;
static HRESULT  (WINAPI* theme_GetThemeFont)(HTHEME,HDC,int,int,int,LOGFONTW*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeInt)(HTHEME,int,int,int,int*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeIntList)(HTHEME,int,int,int,INTLIST*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeMargins)(HTHEME,HDC,int,int,int,RECT*,MARGINS*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeMetric)(HTHEME,HDC,int,int,int,int*) = NULL;
static HRESULT  (WINAPI* theme_GetThemePartSize)(HTHEME,HDC,int,int,const RECT*,enum THEMESIZE,SIZE*) = NULL;
static HRESULT  (WINAPI* theme_GetThemePosition)(HTHEME,int,int,int,POINT*) = NULL;
static HRESULT  (WINAPI* theme_GetThemePropertyOrigin)(HTHEME,int,int,int,PROPERTYORIGIN*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeRect)(HTHEME,int,int,int,RECT*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeStream)(HTHEME,int,int,int,void**,DWORD*,HINSTANCE) = NULL;
static HRESULT  (WINAPI* theme_GetThemeString)(HTHEME,int,int,int,WCHAR*,int) = NULL;
static BOOL     (WINAPI* theme_GetThemeSysBool)(HTHEME,int) = NULL;
static COLORREF (WINAPI* theme_GetThemeSysColor)(HTHEME,int) = NULL;
static HBRUSH   (WINAPI* theme_GetThemeSysColorBrush)(HTHEME,int) = NULL;
static HRESULT  (WINAPI* theme_GetThemeSysFont)(HTHEME,int,LOGFONTW*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeSysInt)(HTHEME,int,int*) = NULL;
static int      (WINAPI* theme_GetThemeSysSize)(HTHEME,int) = NULL;
static HRESULT  (WINAPI* theme_GetThemeSysString)(HTHEME,int,WCHAR*,int) = NULL;
static HRESULT  (WINAPI* theme_GetThemeTextExtent)(HTHEME,HDC,int,int,const TCHAR*,int,DWORD,const RECT*,RECT*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeTextMetrics)(HTHEME,HDC,int,int,TEXTMETRIC*) = NULL;
static HRESULT  (WINAPI* theme_GetThemeTransitionDuration)(HTHEME,int,int,int,int,DWORD*) = NULL;
static HTHEME   (WINAPI* theme_GetWindowTheme)(HWND) = NULL;
static HRESULT  (WINAPI* theme_HitTestThemeBackground)(HTHEME,HDC,int,int,DWORD,const RECT*,HRGN,POINT,WORD*) = NULL;
static BOOL     (WINAPI* theme_IsAppThemed)(void) = NULL;
static BOOL     (WINAPI* theme_IsCompositionActive)(void) = NULL;
static BOOL     (WINAPI* theme_IsThemeActive)(void) = NULL;
static BOOL     (WINAPI* theme_IsThemeBackgroundPartiallyTransparent)(HTHEME,int,int) = NULL;
static BOOL     (WINAPI* theme_IsThemeDialogTextureEnabled)(HWND) = NULL;
static BOOL     (WINAPI* theme_IsThemePartDefined)(HTHEME,int,int) = NULL;
static HTHEME   (WINAPI* theme_OpenThemeData)(HWND,const WCHAR*) = NULL;
static HTHEME   (WINAPI* theme_OpenThemeDataEx)(HWND,const WCHAR*,DWORD) = NULL;
